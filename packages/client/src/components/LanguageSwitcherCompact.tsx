...
export default function LanguageSwitcherCompact() {
    ...
    return (
        <label className={`language-control inline-flex items-center border border-border bg-surface-container-lowest px-2 py-2 text-label-sm text-on-surface ${nextLocaleClass}`}>
